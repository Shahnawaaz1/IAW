      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 sm:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Glowing Enquire Now Button (Never wrap, responsive padding) */}
            <a
              href="#contact"
              className="group flex h-9 sm:h-10 shrink-0 items-center gap-1.5 sm:gap-2.5 rounded-full bg-[#DC2626] px-3.5 sm:px-6 text-[11px] sm:text-xs font-bold tracking-[0.1em] sm:tracking-[0.14em] text-white shadow-[0_0_20px_rgba(220,38,38,0.4)] transition-all duration-300 hover:bg-red-600 hover:shadow-[0_0_30px_rgba(220,38,38,0.7)] hover:-translate-y-0.5 whitespace-nowrap select-none"
            >
