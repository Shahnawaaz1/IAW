...
export function FinalCta() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // 1. Submit lead directly to Google Sheet Webhook
    submitLeadToGoogleSheet({
      name: formData.name,
      phone: formData.phone,
      model: formData.model,
      message: formData.message || "Requesting on-road pricing and test drive schedule.",
      source: "Main Contact Section",
    });

    // 2. Automatically send structured enquiry WhatsApp message to 8429540902
    const message =
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div data-contact-left className="will-change-transform opacity-100">
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/40 bg-blue-500/10 px-3.5 py-1 text-xs font-bold tracking-[0.25em] text-blue-500">
              READY TO MOVE FORWARD?
            </div>
            <h2 className="mt-4 font-display text-4xl sm:text-6xl font-black tracking-tight text-white">
              LET'S FIND
              <br />
              <span className="text-blue-600">YOUR FORCE.</span>
            </h2>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-500/20 text-blue-500 font-bold">
                  📞
                </span>
                <div>
          ...
          <div data-contact-form className="rounded-xl border border-slate-700 bg-[#1E293B] p-8 shadow-2xl will-change-transform opacity-100">
            {submitted ? (
              <div className="py-12 text-center">
                <span className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-blue-500/20 text-3xl text-blue-500">
                  ✓
                </span>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-1.5 w-full rounded-lg border border-slate-600 bg-[#0F172A] px-4 py-3 text-sm text-white placeholder:text-slate-500 focus:border-blue-500 focus:outline-none"
                  />
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="mt-1.5 w-full rounded-lg border border-slate-600 bg-[#0F172A] px-4 py-3 text-sm text-white focus:border-blue-500 focus:outline-none"
                    >
...
export function FloatingWhatsApp() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-3">
      <a
        href={site.emailHref}
        aria-label="Email IAW Force"
        className="flex h-12 w-12 items-center justify-center rounded-full bg-[#EA4335] text-white shadow-xl transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(234,67,53,0.5)]"
      >
      ...
      <a
        href={site.phoneHref}
        aria-label="Call IAW Force"
        className="flex h-12 w-12 items-center justify-center rounded-full bg-[#007AFF] text-white shadow-xl transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(0,122,255,0.5)]"
      >
        <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
      ...
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-[0_0_25px_rgba(37,211,102,0.6)]"
      >
